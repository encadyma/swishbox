<template>
  <div id="app-electron-traffic-lights">
    ...
    <div class="swish-electron-traffic-light" @click="openSettings" :class="{ enabled: $route.name === 'preferences-page' }"><i class="material-icons swish-mi-smaller">settings</i></div>
